...
class _ReportarVehiculoNuevoDialogState extends ConsumerState<ReportarVehiculoNuevoDialog> {
  ...
  Future<void> _reportar() async {
    ...
    final vehiculo = await ref.read(vehiculosRepositoryProvider).reportarNuevo(
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text('Vehículo nuevo', style: Theme.of(context).textTheme.titleLarge),
