...
class _EditarPrecioDialogState extends ConsumerState<EditarPrecioDialog> {
  ...
  late final _precioController =
      TextEditingController(text: widget.precio.precioPorLitro.toStringAsFixed(2));
  ...
  Future<void> _guardar() async {
    ...
    await ref.read(operacionesRepositoryProvider).actualizarPrecio(
        ...
        child: Padding(
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                Text(widget.precio.tipoCombustible,
