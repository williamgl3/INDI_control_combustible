    ...
    return ContenidoResponsivo(
      child: Column(
        ...
        children: [
          ...
          SectionHeader(
            title: 'Unidades',
            subtitle: 'Saldos y operación actual por unidad',
          ...
          SectionHeader(
            ...
            subtitle: 'Consulta y filtra la actividad registrada',
            action: IconButton.filledTonal(
          ...
          AppCard(
            ...
            child: Wrap(
              ...
              children: [
                ...
                TextButton(
                  onPressed: () => setState(
                    () => filtros = const FiltrosRecorridosMarimba(),
                  ),
                        ...
                        AppCard(
                          ...
                          child: ListTile(
                            leading: CircleAvatar(
                              child: Icon(
                                r.estado == EstadoRecorridoMarimba.abierto
                            ...
                            trailing: AppStatusChip(
                              label: r.estado.name,
                              icon: r.estado == EstadoRecorridoMarimba.abierto
                                  ? Icons.play_circle_outline
                                  : Icons.check_circle_outline,
                              color: r.estado == EstadoRecorridoMarimba.abierto
                                  ? context.statusColors.pending
                                  : context.statusColors.approved,
                            ),
                          ),
                        ),
                      Row(
      ...
      child: Column(
        ...
        children: [
          ...
          Wrap(
            ...
            children: [
              AppStatusChip(
                label: unidad.tipoUnidad,
                icon: unidad.tipoUnidad == 'Pipa'
                    ? Icons.water_drop_outlined
                    : Icons.local_shipping_outlined,
                color: context.colors.info,
              ),
              AppStatusChip(
                label: unidad.activo ? 'Activa' : 'Inactiva',
                icon: unidad.activo
                    ? Icons.check_circle_outline
          ...
          _SaldoCombustible(
            nombre: 'Magna',
            valor: saldo(unidad.saldoMagna),
            icono: Icons.local_gas_station_outlined,
          ),
          const SizedBox(height: AppSpacing.sm),
          _SaldoCombustible(
            nombre: 'Diésel',
            valor: saldo(unidad.saldoDiesel),
...
class _SaldoCombustible extends StatelessWidget {
  const _SaldoCombustible({
  ...
  Widget build(BuildContext context) => Row(
    children: [
      Icon(icono, size: 18, color: context.colors.textSecondary),
